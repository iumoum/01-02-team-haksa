	...
	<script>
		$(document).ready(function(){
			...
			$('#addStudentInfo').click(function(){
				window.location.href="/addStudentInfo";
			})
		})
	</script>
</head>
					...
					<aside class="lg-side">
						<div class="inbox-head">
							<div class="input-append">
								<input type="text" class="sr-input" id="studentNumber" placeholder="학번">
								<button class="btn sr-btn" type="button" id="searchButton">
									<i class="fa fa-search"></i>
								</button>
								&ensp; 
								<span>학과</span>&nbsp; 
								<select class="btn sr-btn" name="deptCode" id="deptCode">
									<option value="선택">선택</option>
								</select> 
								&ensp; 
								<span>학년</span>&nbsp; 
								<select class="btn sr-btn" name="grade" id="grade">
									<option value="0">선택</option>
								</select>
								&ensp; 
								<span>반</span>&nbsp; 
								<select class="btn sr-btn" name="departmentClass" id="departmentClass">
									<option value="선택">선택</option>
								</select>
								&ensp; <span>주야</span>&nbsp; 
								<select class="btn sr-btn" name="dayAndNight" id="dayAndNight">
									<option value="선택">선택</option>
								...
								&ensp; 
								<span>구분</span>&nbsp; 
								<select class="btn sr-btn" name="state" id="state">
									<option value="선택">선택</option>
								...
								&ensp;
								<button class="btn sr-btn" type="button" id="addStudentInfo">입력</button>
							</div>
						</div>
