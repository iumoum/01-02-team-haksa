		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$("#attendance").click(function(){
					...
					let classCode = $('#classCode option:selected').val();
					let subjectCode = $('#subjectCode option:selected').val();
					let lectureDateCode = $('#lectureDateCode option:selected').val();
					
					if("선택" != semesterCode && "선택" != departmentCode && "선택" != gradeCode && "선택" != classCode && "선택" != subjectCode && "선택" != lectureDateCode){
						$.ajax({
							url:'/rest/attendance/attendanceList'
							, type:'POST'
							, dataType:'JSON'
							, data: {semesterCode:semesterCode, departmentCode:departmentCode, gradeCode:gradeCode, classesCode:classCode, subjectCode:subjectCode, prelectDate:lectureDateCode}
							, success: function(data){
								console.log("success");
								$(data).each(function(index, item){
									...
									$.each(attendLists, function(index, item){
					                	$('#attendanceTable > tbody').append('<tr>');
				                		$('#attendanceTable > tbody').append('<td>'+item.studentNumber+'</td>');
